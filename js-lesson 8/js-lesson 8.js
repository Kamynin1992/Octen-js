...
// mainBlock.classList.add('wrap', 'collapse', 'alpha', 'beta');
// mainBlock.style.backgroundColor = "black";
// mainBlock.style.color = 'red';
// mainBlock.style.fontSize = '20px';
// mainBlock.style.marginBottom = '20px';
//
// mainBlock.innerText = 'Брат репер';
//
//
// document.body.appendChild(mainBlock);
//
// let clonedBlock = mainBlock.cloneNode(true);
...
//     div.innerHTML = `<h2>${item.title}</h2><p>Duration: ${item.monthDuration} months</p>`;
...
//     nameHeading.textContent = `${person.name} ${person.surname}`;
//
//
//     let infoParagraph = document.createElement('p');
//     infoParagraph.textContent = person.info;
//
//     let img = document.createElement('img');
//     img.src = person.photo;
//     img.alt = `${person.name} ${person.surname}`;
//
//     div.appendChild(nameHeading);
//     div.appendChild(infoParagraph);
//     div.appendChild(img);
//
//
//     container.appendChild(div);
...
coursesArray.forEach(course => {
    ...
    courseBlock.style.backgroundColor = getRandomColor();

    for (const key in course) {
        if (course.hasOwnProperty(key)) {
            const propertyBlock = document.createElement('div');
            propertyBlock.className = 'property';
            ...
            if (key === 'modules') {
                ...
                propertyBlock.appendChild(modulesList);
            } else {
                ...
                propertyBlock.appendChild(propertyHeading);
